    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateField(auto_now=True, verbose_name='updated_time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='created_time')),
                ('updated_time', models.DateField(auto_now=True, verbose_name='updated_time')),
                ('categories', models.ManyToManyField(blank=True, to='products.category', verbose_name='categoties')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.PositiveSmallIntegerField(choices=[(1, 'audio'), (2, 'video'), (3, 'pdf')], verbose_name='file_type')),
